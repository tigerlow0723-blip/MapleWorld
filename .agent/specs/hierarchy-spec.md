...
- [ ] InventoryPanel 엔티티 생성 (Inventory + InventoryUI 부착)
- [ ] GridContainer 엔티티 생성 (InventoryPanel 자식)
- [ ] Cell_1_1 ~ Cell_6_6 (36개) 셀 엔티티 생성
- [ ] ItemTemplate 엔티티 생성 (비활성, Item + SpriteGUIRenderer 부착)
- [ ] ItemDisplayArea 엔티티 생성 (ItemDisplayArea 부착)
- [ ] RewardChest 엔티티 생성 (RewardChest + Button 부착)
- [ ] **BtnBattleStart 엔티티 새로 생성 및 UIMain 컴포넌트에 연결 (`btnBattleStart` 프로퍼티)**
- [ ] 기존 GameLogic에 Inventory 컴포넌트 추가
- [ ] 모든 경로 프로퍼티 설정
